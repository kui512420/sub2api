...
const BADGE: Record<Platform, string> = {
  ...
  // 椒图（图片/视频号池上游）：取 amber，与国产供应商的 rose / teal / indigo / pink 区分
  jiaotu: 'bg-amber-500/10 text-amber-600 border-amber-500/30 dark:text-amber-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  jiaotu: 'bg-amber-500/10 text-amber-600 dark:bg-amber-500/10 dark:text-amber-300',
...
const BORDER: Record<Platform, string> = {
  ...
  jiaotu: 'border-amber-500/20 dark:border-amber-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  jiaotu: 'border-amber-500/35 dark:border-amber-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  jiaotu: 'bg-gradient-to-r from-amber-400 to-amber-500',
...
const TEXT: Record<Platform, string> = {
  ...
  jiaotu: 'text-amber-600 dark:text-amber-400',
...
const ICON: Record<Platform, string> = {
  ...
  jiaotu: 'text-amber-500 dark:text-amber-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  jiaotu: 'bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 dark:bg-amber-500/80 dark:hover:bg-amber-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  jiaotu: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  jiaotu: 'from-amber-500 to-amber-600',
