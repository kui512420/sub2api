export default {
    settings: {
      ...
      payment: {
        ...
        limitBonusMultiplier: 'Bonus multiplier',
        bonusMultiplierUseGlobal: 'Use global multiplier',
        bonusMultiplierHint: 'Leave empty to use the global bonus multiplier. A value here overrides the global one (they do not multiply); e.g. 1.2 credits 120 for a 100 payment',
