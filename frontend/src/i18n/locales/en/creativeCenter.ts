export default {
  creativeCenter: {
    ...
    workspace: {
      ...
      image: {
        resultDescription: 'Display jobs, previews, and downloads returned by the standard OpenAI image API.',
        modelValue: 'OpenAI image model',
        modelHint: 'The model name maps directly to the standard OpenAI image API model field.',
